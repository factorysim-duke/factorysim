...
public class SimpleLatSourcePolicyTest {
  ...
  public void test_equal_latency() {
    ...
    metalMine1.prependPendingRequest(new Request(0, metal, metalMine1.getMiningRecipe(), metalMine1, doorFactory));
    metalMine2.prependPendingRequest(new Request(1, metal, metalMine2.getMiningRecipe(), metalMine2, doorFactory));
  ...
  public void test_min_latency() {
    ...
    waterMine1.prependPendingRequest(new Request(2, water, waterMine1.getMiningRecipe(), waterMine1, doorFactory));
    waterMine1.prependPendingRequest(new Request(3, water, waterMine1.getMiningRecipe(), metalMine1, doorFactory));
    // add 1 request to water mine 2
    waterMine2.prependPendingRequest(new Request(5, water, waterMine2.getMiningRecipe(), waterMine2, doorFactory));
    // add 1 requests to water mine 3
    waterMine3.prependPendingRequest(new Request(6, water, waterMine3.getMiningRecipe(), waterMine3, doorFactory));
